...
export const COMMENT_HELPER_VERSION = '1.3.7';
export const COMMENT_HELPER_DOWNLOAD_URL =
  'https://github.com/nettman001-hub/voice-pin-web/releases/download/comment-helper-v1.3.7/VoiceCAP-Comment-Helper-Setup.exe';
