...
| **댓글 도우미 (Windows)** | `v1.3.5` ([다운로드 직링크](https://github.com/nettman001-hub/voice-pin-web/releases/download/comment-helper-v1.3.5/VoiceCAP-Comment-Helper-Setup.exe)) |
